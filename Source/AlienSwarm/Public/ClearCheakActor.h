...
#include "ClearCheakActor.generated.h"

UCLASS()
class ALIENSWARM_API AClearCheakActor : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	UPROPERTY(EditDefaultsOnly)
	class UTextRenderComponent* clearText;
...
public:	
	...
	bool bIsClearReady = false;

	int32 waitingPlayers = 0;

	class ATestPlayerController* hostPC;
};
